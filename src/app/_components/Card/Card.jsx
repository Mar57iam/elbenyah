...
export default function Card({ card }) {
  ...
  return (
    ...
    <div className="relative w-full max-w-[580px] h-[350px] sm:h-[431px] mx-auto">
    <Link
      href={``}
      className="block w-full max-w-[514px] h-full rounded-[30px] sm:rounded-[40px] overflow-hidden shadow-md relative mx-auto"
    >
      <img
