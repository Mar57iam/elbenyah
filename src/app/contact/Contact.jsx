        ...
        <form onSubmit={formik.handleSubmit} className="space-y-4">
          ...
          <div className="relative">
            <input
              ...
              dir={isArabic ? 'rtl' : 'ltr'}
              className={`w-full h-[50px] ${isArabic ? 'pr-10' : 'pl-10'} border border-gray-300 rounded-full text-sm`}
            />
          ...
          {/* Phone */}
          <div className="relative">
            <div className="absolute start-0 top-0 h-full flex items-center ps-3 gap-1 text-sm text-gray-600">
              <img src="https://flagcdn.com/w40/eg.png" alt="EG" className="w-5 h-5 rounded-sm" /> +20
            </div>
            <input
              name="phone"
              type="tel"
              ...
              onBlur={formik.handleBlur}
              dir={isArabic ? 'rtl' : 'ltr'}
              className="w-full h-[50px] ps-[65px] pe-4 border border-gray-300 rounded-full text-sm"
            />
